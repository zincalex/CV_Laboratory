...
int main(int argc, char** argv)
{
    ...
    // Task 1
    //
    Mat Garden_grayscale = imread(PATH + "/GardenModifiedGrayscale.jpg");
    ...
    Mat Garden_modified = max_filter(Garden_grayscale, KS_maxORmin);
    ...
    Garden_modified = median_filter(Garden_grayscale, KS_median);
