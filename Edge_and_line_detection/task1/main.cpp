...
static void CannyThreshold(int, void*) {
    ...
    GaussianBlur(street_gray, detected_edges, Size(kernel_size_Gauss,kernel_size_Gauss), 0);
...
int main(int argc, char** argv) {
    ...
    createTrackbar( "Kernel size Canny:", window_name, &kernel_size, max_kernelThreshold, CannyThreshold);
